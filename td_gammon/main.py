...
if __name__ == '__main__':
    ...
    # parser.add_argument('--save_path', help='Save directory location', type=str, default=None)
    # parser.add_argument('--save_step', help='Save the model every n episodes/games', type=int, default=0)
    # parser.add_argument('--episodes', help='Number of episodes/games', type=int, default=200000)
    # parser.add_argument('--init_weights', help='Init Weights with zeros', action='store_true')
    # parser.add_argument('--lr', help='Learning rate', type=float, default=0.1)
    # parser.add_argument('--hidden_units', help='Hidden units', type=int, default=40)
    # parser.add_argument('--lamda', help='Credit assignment parameter', type=float, default=0.7)
    # parser.add_argument('--model', help='Directory location to the model to be restored', type=str, default=None)
    # parser.add_argument('--name', help='Name of the experiment', type=str, default='exp1')
    # parser.add_argument('--type', help='Model type', choices=['cnn', 'nn'], type=str, default='nn')
    # parser.add_argument('--seed', help='Seed used to reproduce results', type=int, default=548)

    # parser.set_defaults(func=utils.args_train)
